...
bare_directory = 'E:\\Chrome Download\\Ferrocene\\App'
struc_directory = 'E:\\Chrome Download\\Ferrocene\\App Struc'
...
change = ((fit[1][0] - fit[0][0]) /fit[0][0])
print(fit[1][0])
print(fit[0][0])
print(change)
...
#plt.savefig(os.path.join(bare_directory,'aperture results.png'), dpi=300)
plt.show()