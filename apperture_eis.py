...
before_directory = 'E:\\Chrome Download\\Ferrocene\\Apperture Struc IS'
...
ax2.legend(['Structured', 'After HCl', 'No Structure'], loc = 'upper center')
ax2.set_ylabel('Magnitude ($\Omega$)')
ax3.set_ylabel('Phase (degrees)')
fig.subplots_adjust(wspace = 0.3)
plt.savefig(os.path.join(before_directory,'App structuring Impedance.png'), dpi=300)
plt.show()